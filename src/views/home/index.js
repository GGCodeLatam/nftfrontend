    ...
    platziPunks.methods
      ...
      .on("receipt", () => {
        ...
        toast({
          ...
          description: "Welcome to the GG Family!",
          status: "success",
        });
      })
      .on("error", (error) => {
  ...
  return (
    ...
    >
      <Stack flex={1} spacing={{ base: 5, md: 10 }}>
        ...
        <Text color={"gray.500"}>
          GG Punks es una colección de Avatares randomizados cuya metadata
          es almacenada on-chain. Poseen características únicas y sólo hay 10000
          en existencia.
        </Text>
        <Text color={"green.500"}>
          Cada GG Punk se genera de forma secuencial basado en tu address,
          usa el previsualizador para averiguar cuál sería tu GG Punk si
